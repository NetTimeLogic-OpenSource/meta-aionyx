...
git://git.savannah.gnu.org/config.git git://git.savannah.gnu.org/config.git;protocol=https \n \
git://git.infradead.org/mtd-utils.git git://git.infradead.org/mtd-utils.git;protocol=https \n \
"